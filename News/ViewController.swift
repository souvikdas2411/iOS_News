...
class ViewController: UIViewController, UITableViewDelegate, UITableViewDataSource, UICollectionViewDelegate, UICollectionViewDataSource{
   ...
   override func viewDidLoad() {
       ...
       defURL = "https://newsapi.org/v2/top-headlines?sources=google-news-in&apiKey=yourAPIkey"
...
//        self.overrideUserInterfaceStyle = .dark
   ...
   func collectionView(_ collectionView: UICollectionView, didSelectItemAt indexPath: IndexPath) {
       ...
       if cell.textLabel.text == "Headlines India"{
           ...
           datas.removeAll()
           self.tableView.reloadData()
           defURL = "https://newsapi.org/v2/top-headlines?country=in&apiKey=yourAPIkey"
           self.getData(source: defURL)
       }
       if cell.textLabel.text == "Headlines US"{
           ...
           datas.removeAll()
           self.tableView.reloadData()
           defURL = "https://newsapi.org/v2/top-headlines?country=us&apiKey=yourAPIkey"
           self.getData(source: defURL)
       }
       if cell.textLabel.text == "India Business Headlines"{
           ...
           datas.removeAll()
           self.tableView.reloadData()
           defURL = "https://newsapi.org/v2/top-headlines?country=in&category=business&apiKey=yourAPIkey"
           self.getData(source: defURL)
       }
       ...
       if cell.textLabel.text == "Tech Scrape"{
           ...
           datas.removeAll()
           self.tableView.reloadData()
           defURL = "https://newsapi.org/v2/everything?domains=thenextweb.com,wired.com,tech2.com&apiKey=yourAPIkey"
           self.getData(source: defURL)
       }
